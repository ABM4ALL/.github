...
and CovidNetworkContagionVisual [[code](https://github.com/ABM4ALL/CovidNetworkContagionVisual)] [[doc](https://abm4all.github.io/Melodie/html/gallery/covid_contagion_visual.html)]
  * [ABMFrameworkComparison](https://github.com/ABM4ALL/ABMFrameworkComparison) - to compare the three Python packages - Mesa, AgentPy, and Melodie - we develop a same agent-based covid contagion model with all of them.
